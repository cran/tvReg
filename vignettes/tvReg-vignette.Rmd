...
for download from the RtvSURE*, *tvVAR* and *tvIRF*. Moreover, this package provides tools for the graphical display of results, extraction of residuals fitted values, bandwidth calculation, estimation of the time-varying variance-covariance matrix of the error term and two estimation procedure: the time-varying ordinary least squares programmed in function *tvOLS* and the time-varying generalised least squares in function *tvGLS*."
